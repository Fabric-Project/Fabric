            ...
            VStack
            {
                ...
                HStack(alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/, spacing: 0.0, content:
                    ...
                    ZStack(alignment: .leading)
                    {
                        ...
                        Rectangle()
                            .foregroundColor(self.sliderForegroundColor)
                            .frame(width: sliderWidth * CGFloat( remap(self.vm.uiValue.w,
                                                                       self.vmMin.uiValue.w,
                                                                       self.vmMax.uiValue.w,
                                                                       0.0,
                                                                       1.0) ) )
                        HStack
                        {
                            ...
                            Text(String(format: "%0.2f", vm.uiValue.w) )
                                .frame(maxWidth: .infinity, alignment: .trailing)
                                .font(.system(size: 10))
                        }
                        .padding()
                    ...
                    .gesture(DragGesture(minimumDistance: 0)
                        .onChanged({ v in
                            ...
                            vm.uiValue.w = remap(normalizedValue,
                                                 0.0,
                                                 1.0,
                                                 vmMin.uiValue.w,
                                                 vmMax.uiValue.w)
