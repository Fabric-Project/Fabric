...
//
// description: Simulates Technicolor Process 1 film look
                             ...
                             texture2d<half, access::sample>   tex        [[texture( FragmentTextureCustom0 )]] )
{
    ...
    const half4 bluegreenfilter = half4(0.0h, 1.0h, 0.7h, 1.0h);
    ...
    // Re-apply filters
    half4 redoutput       = rednegative       * redfilter;
    half4 bluegreenoutput = bluegreennegative * bluegreenfilter;
