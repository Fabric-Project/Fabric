                            ...
                            constant PostUniforms &uniforms [[buffer( FragmentBufferMaterialUniforms )]])
{
    ...
    {
        result.r = fbm(float3(result.r * uniforms.scaleR * in.texcoord, uniforms.timeR)) * 0.5 + 0.5;
        result.g = fbm(float3(result.g * uniforms.scaleG * in.texcoord, uniforms.timeG)) * 0.5 + 0.5;
        result.b = fbm(float3(result.b * uniforms.scaleB * in.texcoord, uniforms.timeB)) * 0.5 + 0.5;
    }
