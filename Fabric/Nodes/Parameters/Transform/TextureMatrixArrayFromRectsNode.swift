//
//  TextureMatrixArrayFromRectsNode.swift
//  Fabric
//
...
public class TextureMatrixArrayFromRectsNode : Node
{
    ...
    override public class func registerPorts(context: Context) -> [(name: String, port: Port)] {
        ...
        return ports +
        [
            ("inputSourceRects", NodePort<ContiguousArray<simd_float4>>(name: "Source Rects", kind: .Inlet, description: "Per-element source UV rect (x, y, width, height)")),
            ("inputTargetRects", NodePort<ContiguousArray<simd_float4>>(name: "Target Rects", kind: .Inlet, description: "Per-element target UV rect (x, y, width, height)")),
