...
public class ForegroundMaskNode: Node, NodeFileLoadingProtocol
{
    class var name:String { "Foreground Mask" }
        
    class var nodeType:Node.NodeType { .Image(imageType: .Mask) }
