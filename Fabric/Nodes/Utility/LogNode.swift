...
public class LogNode : Node
{
    ...
    {
        self.inputAny = NodePort<PortValue>(name: "Log Value" , kind: .Inlet, description: "Value to print to console")
                                 ...
                                 commandBuffer: MTLCommandBuffer)
    {
        ...
        {
            print("Frame: \(executionInfo.timing.frameNumber): \(self.inputAny.portType.previewString(for: value))" )
        }
    }
}
