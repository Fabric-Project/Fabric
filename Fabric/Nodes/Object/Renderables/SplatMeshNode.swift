...
public class SplatMeshNode : MeshNode
{
    public override class var name:String { "Splat Mesh" }
    ...
    override public class var nodeDescription: String { "Load an 3D Gaussian Splat file from disk, rendering it to the scene"}
